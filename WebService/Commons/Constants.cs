...
namespace WebService.Commons
{
    public static class Constants
    {
        ...
        //@"Data Source=server-erp\asmsdev;Initial Catalog=SLW_Database;Integrated Security=True";

        public const string databaseConnection = @"Data Source=server-erp\asmsdev;Initial Catalog=SLW_Database;Integrated Security=True";
